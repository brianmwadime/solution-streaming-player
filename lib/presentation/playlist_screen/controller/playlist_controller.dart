...
class PlaylistController extends GetxController {
  ...
  Future<void> addToPlaylist(dynamic request,
      {VoidCallback? successCall, VoidCallback? errCall}) async {
    return Get.find<ApiClient>().addSongToPlaylist(
        onSuccess: (response) {
          onAddToPlaylistSuccess(response);
          if (successCall != null) {
            successCall();
          }
        },
  ...
  void onAddToPlaylistSuccess(var response) {
    print(response);
